...
## Project Structure
    ...
    ├── throbbing_glade_dev_96345  # Django project configurations
...
1. Clone this repo and `cd throbbing_glade_dev_96345`
...
2. Clone this repo and `cd throbbing_glade_dev_96345`
